package com.example.bilaizi.fingerprintdialog;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            purchaseButtonNotInvalidated.setOnClickListener(
                    new PurchaseButtonClickListener(cipherNotInvalidated, KEY_NAME_NOT_INVALIDATED)
            );
        } else {
     ...
     */
    //KeyStore存放获取密钥,创建并初始化 Cipher 对象
